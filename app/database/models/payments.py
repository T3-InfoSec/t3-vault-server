...
class Payment(Base):
    ...
    currency_id = Column(Integer, nullable=False)  # Foreign key to Currency Index
    method_id = Column(Integer, nullable=False)  # Foreign key to Method Index
    reason_id = Column(Integer, nullable=False)  # Foreign key to Reason Index
...
class Currency(Base):
    ...
    name = Column(String, nullable=False)  # Name of the currency (e.g., USD, EUR)
...
class PaymentMethod(Base):
    ...
    name = Column(String, nullable=False)  # Name of the payment method (e.g., Credit Card, PayPal)
...
class PaymentReason(Base):
    ...
    name = Column(String, nullable=False)  # Name of the payment reason (e.g., Subscription, Donation)
